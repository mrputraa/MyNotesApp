...
// kelas ini berfungsi untuk menampilkan data per baris di komponen viewgroup seperti RecyclerView-
// dengan data yang berasal dari objek linkedlist bernama listNotes
// Termasuk juga di dalamnya implementasi dari CustomOnItemClickListener-
...
class NoteAdapter (private val activity: Activity): RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    //list utk menampung item2 dlm bentuk cardview dalam recyclerview
        ...
        fun bind(note: Note){
            with(itemView){
                ...
                cv_item_note.setOnClickListener(CustomOnItemClickListener(adapterPosition, object : CustomOnItemClickListener.OnItemClickCallback {
                    override fun inItemClicked(view: View, position: Int) {
